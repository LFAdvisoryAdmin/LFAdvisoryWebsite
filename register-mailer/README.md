...
Sends each **preparer** their tasks every morning at **3am Brisbane** (cron `0 17 * * *` = 17:00 UTC), with **Liam CC'd**. Reads the register straight from SharePoint and sends via Outlook — all inside your Microsoft 365 tenant, no external email service.
