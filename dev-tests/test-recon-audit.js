...
console.log('\n--- LSL-related text calls by page ---');
texts.filter(t => /LONG SERVICE|LSL|Liability|AASB/i.test(t.txt)).forEach(t => console.log(`p${t.page}: ${t.txt}`));
console.log('\nTotal text calls:', texts.length, '| pages:', pageNum);
